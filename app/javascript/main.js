...
$(function(){
  ...
  mw('#modal_1','#modal_content_1','#btn_modal_1','.btn_close');
  mw('#modal_2','#modal_content_2','#btn_modal_2','.btn_close');
  mw('#modal_3','#modal_content_3','#btn_modal_3','.btn_close');
});
...
// -----
// form & not-show-google &thxMessage
// -----

function showThxMessage(){
  var email = document.myForm.elements['entry.1045781291'].value;
  if(email !== ''){
